  ...
  return( 
      <div >
            <div className="part-1">
                    <p className="style-11 text-no-decoration">We are leaders in 10 countries:
                    ...
                    <p className="style-11">This site uses cookies to deliver services in accordance with this Privacy Policy. You can specify the conditions for storing or accessing cookies on your browser.</p>
            
                    <p className="style-11 margin-5">www.docplanner.com © 2019</p>   
                </div>
    </div>
